...
function newsfeedComponentMaker(
  ...
  firstPara.classList.add("paragraphElements");
  firstPara.textContent = firstParagraphData;

  const secondPara = document.createElement("p");
  secondPara.classList.add("paragraphElements");
  secondPara.textContent = secondParagraphData;

  const thirdPara = document.createElement("p");
  thirdPara.classList.add("paragraphElements");
  thirdPara.textContent = thirdParagraphData;
  ...
  articleElement.appendChild(firstPara);
  articleElement.appendChild(secondPara);
  articleElement.appendChild(thirdPara);
